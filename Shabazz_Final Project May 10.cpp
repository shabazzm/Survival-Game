...
{	//variables to be used in program
    ...
    double coefficient[FUNCTION];
   	double fPower[FUNCTION];
    ...
    double upperVal=0, lowerVal=0;
 	...
 	cin>>terms;
    FUNCTION=terms; //setting array size indicator = to number of terms.
	...
	//using for loop to collect function from user and store in two separate arrays
	
  for (int index=0; index<FUNCTION;index++)
  {
